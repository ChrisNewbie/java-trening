...
import pl.training.module06.model.Currency;
import pl.training.module06.model.InsufficientFoundsException;
...
//        account.withdraw(amount);
    ...
    private Optional<Account> getAccount(String accountNumber) throws AccountNotFoundException {
